String Versione = "amp_sogl_18_sms3";
/*
...
float floatVoltage;
char strVoltage[5] = "12.5";; // 4 caratteri + 1 per il terminatore di stringa

int intCurrent;
char strCurrent[6] = "0250"; // 5 caratteri + 1 per il terminatore di stringa

int intSogliaMilliampere; 
char StrSogliaMilliampere[5] = "1500"; // 4 caratteri + 1 per il terminatore di stringa
...
void loop(){
  ...
  while (true) {
    ...
    Serial.println(F(" P R O V A   A  F A R L E  S O L O  1  V O L T A   A L   S E C O N D O"));
      ...
      if (index != -1) {
        ...
        if (raw.indexOf(TempString) != -1) {
          ...
          sendSMS(numero, String(msgdati));
            ...
            sendSMS(numero1, "Reset SIM e CPU in corso...");
            Azione12(); //reset sim
            delay(1000);
            Azione0(); //reset cpu
...
//xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx
// EEPROM - scrittura numeri telefono
...
//xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx
// EEPROM - lettura  numeri telefono
