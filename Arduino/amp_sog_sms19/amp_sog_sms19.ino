...
void Azione4(void){
  ...
  lcd.print(" SmA");
  TestoSmsUltimiDati = "";
  Serial.println("TRACE_TestoSmsUltimiDati VOID");
  TestoSmsUltimiDati = TestoSmsUltimiDati + " Soglia=";
  Serial.println("TRACE_Soglia");

  lcd.setCursor(12, 0); // Posiziona il cursore sulla prima riga, colonna 1
  lcd.print(StrSogliaMilliampere);
  TestoSmsUltimiDati = TestoSmsUltimiDati + StrSogliaMilliampere;
}
...
*/
  ...
  lcd.print("ImA=");
  TestoSmsUltimiDati = TestoSmsUltimiDati + " Corrente=";
  Serial.println("TRACE_Corrente");
  lcd.setCursor(3, 0); // Posiziona il cursore sulla prima riga, colonna 1
  lcd.print(strCurrent);
  TestoSmsUltimiDati = TestoSmsUltimiDati + strCurrent;
...
*/
  ...
  lcd.print("Volt");
  TestoSmsUltimiDati = TestoSmsUltimiDati + " Volt=";
  Serial.println("TRACE_Volt");
  lcd.setCursor(4, 1); // Posiziona il cursore sulla prima riga, colonna 1
  lcd.print(strVoltage);
  TestoSmsUltimiDati = TestoSmsUltimiDati + strVoltage;
...
void Azione10(void){
  ...
  lcd.print(" Err");
  TestoSmsUltimiDati = TestoSmsUltimiDati + " TimeCurrHi=";
  Serial.println("TRACE_TimeCurrHi");

  lcd.setCursor(12, 1); // Posiziona il cursore sulla prima riga, colonna 1
  lcd.print(strContaSecondiCorrenteElevata);
  TestoSmsUltimiDati = TestoSmsUltimiDati + strContaSecondiCorrenteElevata;


  TestoSmsUltimiDati = TestoSmsUltimiDati + " TimeTotal=";
  TestoSmsUltimiDati = TestoSmsUltimiDati + String(ContaSecondi);
  Serial.println("TRACE_TimeTotal");
  ...
  if (InviaOraSms){
    ...
    Serial.println(TestoSmsUltimiDati);
    Serial.println("qualcosa non va qui, sms vuoto");
    //sendSMS(PrefissoInt + NumeroUtente1, TestoSmsUltimiDati);
    //sendSMS(PrefissoInt + NumeroUtente2, TestoSmsUltimiDati);
