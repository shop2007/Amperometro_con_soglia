...
Tramite un partitore di tensione ed un diodo in serie ho rilevato i seguenti valori:
- con tensione di ingresso di 12v l'ADC segna 900 bit 
- con tensione di ingresso di 2v l'ADC segna 20 bit
...
output funzione: 
 ...
 - float Voltage ; // valore di tensione in volt interpolato
 - String StrVoltage ; // valore di Voltage , 5 digit , valore in volt con due cifre dopo la virgola,  sostituendo lo zer non significativo delle decine di volt con uno space 
